...
if __name__ == "__main__":
    ...
    train_parser.add_argument("-n", "--num_steps", type=int, default=2000,
                              help="Maximum number of steps. Defaults to 2000.")
    ...
    train_parser.add_argument("-w", "--layers_width", type=int, default=500,
                              help="Layer width (constant). Defaults to 500.")
    train_parser.add_argument("-z", "--latent_dim", type=int, default=2,
                              help="Number of latent variable dimensions. "\
                              "Defaults to 2.")
    train_parser.add_argument("-I", "--init", default="uniform",
                              choices=("uniform", "gaussian"),
                              help="Initial weights distribution. "\
                              "Defaults to uniform.")
